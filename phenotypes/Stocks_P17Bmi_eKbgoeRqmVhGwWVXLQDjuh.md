---
layout: phenotype
title: Body Mass Index (P17)
phenotype_id: eKbgoeRqmVhGwWVXLQDjuh
name: Body Mass Index (P17)
type: Biomarker
group: Biomarker
sources: 
    - clinicalcodes
...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Stocks_P17Bmi_eKbgoeRqmVhGwWVXLQDjuh_Read2.csv
...
{% include csv.html csvdata=site.data.codelists.Stocks_P17Bmi_eKbgoeRqmVhGwWVXLQDjuh_Read2 %}
