...
phenotype_id: awKCFANZHST5waRGYgTqLm
name: Smoking Status
...
clinical_terminologies:
    ...
    - OXMIS	
validation:
codelists: Doran_SmokingStatus_awKCFANZHST5waRGYgTqLm_OXMISRead.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_SmokingStatus_awKCFANZHST5waRGYgTqLm_OXMISRead %}
