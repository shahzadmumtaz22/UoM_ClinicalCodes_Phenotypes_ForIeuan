...
layout: phenotype
title: Statins
phenotype_id: ZWGLDREnfPKRwwZL6YXNiC
name: Statins
...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Statins_ZWGLDREnfPKRwwZL6YXNiC_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Statins_ZWGLDREnfPKRwwZL6YXNiC_CPRDProductCode %}
