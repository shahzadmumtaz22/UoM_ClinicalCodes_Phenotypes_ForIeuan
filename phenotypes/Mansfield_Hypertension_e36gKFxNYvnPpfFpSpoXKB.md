...
clinical_terminologies:
    ...
    - Read Version 2
validation:
codelists: Mansfield_Hypertension_e36gKFxNYvnPpfFpSpoXKB_ICD10Read.csv
...
{% include csv.html csvdata=site.data.codelists.Mansfield_Hypertension_e36gKFxNYvnPpfFpSpoXKB_ICD-10Read %}
