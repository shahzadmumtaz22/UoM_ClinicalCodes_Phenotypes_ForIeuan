...
layout: phenotype
title: Depot APDs
phenotype_id: TKgnYBXwAZwZNApZsDtB9E
name: Depot APDs
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - Multilex
validation:
codelists: Windfuhr_Depotapds_TKgnYBXwAZwZNApZsDtB9E_Multilex.csv
...
{% include csv.html csvdata=site.data.codelists.Windfuhr_Depotapds_TKgnYBXwAZwZNApZsDtB9E_Multilex %}
