...
phenotype_id: 9yrRvaxxZvUYrtdooqJbME
name: Tricyclic Adds
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - Multilex
validation:
codelists: Carr_Tricyclicadds_9yrRvaxxZvUYrtdooqJbME_Multilex.csv
...
{% include csv.html csvdata=site.data.codelists.Carr_Tricyclicadds_9yrRvaxxZvUYrtdooqJbME_Multilex %}
