...
layout: phenotype
title: Metformin
phenotype_id: NWE92qvdRWmUwHXrzGugSW
name: Metformin
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Zhong_Metformin_NWE92qvdRWmUwHXrzGugSW_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Zhong_Metformin_NWE92qvdRWmUwHXrzGugSW_CPRDProductCode %}
