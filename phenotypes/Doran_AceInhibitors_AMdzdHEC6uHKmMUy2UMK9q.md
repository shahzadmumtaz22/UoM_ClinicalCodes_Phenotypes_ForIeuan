...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Doran_AceInhibitors_AMdzdHEC6uHKmMUy2UMK9q_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_AceInhibitors_AMdzdHEC6uHKmMUy2UMK9q_CPRDProductCode %}
