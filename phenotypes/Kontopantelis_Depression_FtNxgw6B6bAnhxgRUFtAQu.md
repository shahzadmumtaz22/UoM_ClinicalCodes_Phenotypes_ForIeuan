...
layout: phenotype
title: Depression
phenotype_id: FtNxgw6B6bAnhxgRUFtAQu
name: Depression
...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Kontopantelis_Depression_FtNxgw6B6bAnhxgRUFtAQu_Read2.csv
...
{% include csv.html csvdata=site.data.codelists.Kontopantelis_Depression_FtNxgw6B6bAnhxgRUFtAQu_Read2 %}
