...
layout: phenotype
title: Digoxin (P9)
phenotype_id: eTdfKgiXYaBKxXPFRAD3Sm
name: Digoxin (P9)
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Stocks_P9Digoxin_eTdfKgiXYaBKxXPFRAD3Sm_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Stocks_P9Digoxin_eTdfKgiXYaBKxXPFRAD3Sm_CPRDProductCode %}
