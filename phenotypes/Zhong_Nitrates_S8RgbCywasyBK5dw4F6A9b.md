...
layout: phenotype
title: Nitrates
phenotype_id: S8RgbCywasyBK5dw4F6A9b
name: Nitrates
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Zhong_Nitrates_S8RgbCywasyBK5dw4F6A9b_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Zhong_Nitrates_S8RgbCywasyBK5dw4F6A9b_CPRDProductCode %}
