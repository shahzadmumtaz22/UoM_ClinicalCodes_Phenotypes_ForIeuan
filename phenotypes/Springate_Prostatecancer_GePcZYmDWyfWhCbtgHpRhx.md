...
phenotype_id: GePcZYmDWyfWhCbtgHpRhx
...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Springate_Prostatecancer_GePcZYmDWyfWhCbtgHpRhx_Read2.csv
...
{% include csv.html csvdata=site.data.codelists.Springate_Prostatecancer_GePcZYmDWyfWhCbtgHpRhx_Read2 %}
