...
layout: phenotype
title: Depot APDs
phenotype_id: EQGhUP7RxRwFabu8XgXcaM
name: Depot APDs
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - Multilex
validation:
codelists: Carr_Depotapds_EQGhUP7RxRwFabu8XgXcaM_Multilex.csv
...
{% include csv.html csvdata=site.data.codelists.Carr_Depotapds_EQGhUP7RxRwFabu8XgXcaM_Multilex %}
