...
phenotype_id: cdapmjEF4DnFhkbRJM8h2Y
name: Tricyclic Adds
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - Multilex
validation:
codelists: Carr_Tricyclicadds_cdapmjEF4DnFhkbRJM8h2Y_Multilex.csv
...
{% include csv.html csvdata=site.data.codelists.Carr_Tricyclicadds_cdapmjEF4DnFhkbRJM8h2Y_Multilex %}
