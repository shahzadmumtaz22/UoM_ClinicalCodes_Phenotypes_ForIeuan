...
phenotype_id: 6jh6V6C8yYe3Mmi9X7JMza
name: Ace Inhibitors
type: Drugs
group: 
sources: 
...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Doran_AceInhibitors_6jh6V6C8yYe3Mmi9X7JMza_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Doran_AceInhibitors_6jh6V6C8yYe3Mmi9X7JMza_CPRDProductCode %}
