...
layout: phenotype
title: Beta Blockers
phenotype_id: BKsQQFgHG76e2DiKmfi6Dz
name: Beta Blockers
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Springate_BetaBlockers_BKsQQFgHG76e2DiKmfi6Dz_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Springate_BetaBlockers_BKsQQFgHG76e2DiKmfi6Dz_CPRDProductCode %}
