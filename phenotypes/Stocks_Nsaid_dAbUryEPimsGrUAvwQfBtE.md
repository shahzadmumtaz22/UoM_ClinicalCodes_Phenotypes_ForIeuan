...
layout: phenotype
title: NSAID
phenotype_id: dAbUryEPimsGrUAvwQfBtE
name: NSAID
type: Drug
group: Drug
sources: 
...
clinical_terminologies:
    - CPRD Product Code
validation:
codelists: Stocks_Nsaid_dAbUryEPimsGrUAvwQfBtE_CPRDProductCode.csv
...
{% include csv.html csvdata=site.data.codelists.Stocks_Nsaid_dAbUryEPimsGrUAvwQfBtE_CPRDProductCode %}
