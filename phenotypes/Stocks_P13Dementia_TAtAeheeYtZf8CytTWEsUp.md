...
layout: phenotype
title: Dementia (P13)
phenotype_id: TAtAeheeYtZf8CytTWEsUp
name: Dementia (P13)
...
clinical_terminologies:
    - Read Version 2
validation:
codelists: Stocks_P13Dementia_TAtAeheeYtZf8CytTWEsUp_Read2.csv
...
{% include csv.html csvdata=site.data.codelists.Stocks_P13Dementia_TAtAeheeYtZf8CytTWEsUp_Read2 %}
